...
class VectorIndex:
    ...
    def __init__(self, persist_directory: Optional[Path] = None):
        ...
        # Initialize embeddings via ProxyAPI OpenAI-compatible endpoint
        self.embeddings = OpenAIEmbeddings(
            model=EMBEDDING_MODEL,
            openai_api_key=PROXYAPI_KEY,
            openai_api_base=PROXYAPI_OPENAI_URL,
        )
        logger.info(f"RAG embeddings via ProxyAPI: {PROXYAPI_OPENAI_URL}")
